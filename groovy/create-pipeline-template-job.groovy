...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/ci-cloudbees-jjamello-instance/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>ci-cloudbees-jjamello-instance</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>ci-cloudbees-jjamello-instance</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/ci-cloudbees-jjamello-instance/pipeline-template-catalog.git</repositoryUrl>
              <traits>
